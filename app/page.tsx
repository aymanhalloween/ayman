      ...
      <main className="max-w-[680px] mx-auto px-6 py-16">
        ...
        <section className="mb-16">
          ...
          <p className="text-[16px] leading-[1.6]">
            I have experience building product at Apple, running strategy and ops at Nike, and being an operating partner at Alif VC. Currently consulting for startups and building cool stuff on the side. Always open to{' '}
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex justify-between items-start mb-1">
                <p className="text-[16px]">Consulting for various companies</p>
            ...
            <div>
              ...
              <div className="flex justify-between items-start mb-1">
                <p className="text-[16px]">Operating Partner</p>
